package de.greenrobot.performance.sqlcipher;
...
public class PerfTestSqlite extends BasePerfTestCase {
    ...
    private static final String DATABASE_PASSWORD = "standard-password";
    private static final int DATABASE_VERSION = 1;
    private SQLiteDatabase database;
    private String[] emptyWhereArgs = new String[0];
    ...
    private void indexedStringEntityQueriesRun(SQLiteDatabase database, int count) {
        ...
        // delete all entities
        database.delete(DbHelper.Tables.INDEXED_ENTITY, null, emptyWhereArgs);
